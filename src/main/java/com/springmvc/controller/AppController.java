...
public class AppController
{
    ...
    public String saveUser(@Valid User user, BindingResult result, ModelMap model)
    {
        ...
        /*
         * Preferred way to achieve uniqueness of field [sso] should be implementing custom @Unique annotation and
         * applying it on field [sso] of Model class [User].
         * 
    ...
    public String updateUser(@Valid User user, BindingResult result, ModelMap model, @PathVariable String ssoId)
    {
         ...
         * if(!userService.isUserSSOUnique(user.getId(), user.getSsoId())){ FieldError ssoError =new
         * FieldError("user","ssoId",messageSource.getMessage("non.unique.ssoId", new
         * 
         * String[]{user.getSsoId()}, Locale.getDefault())); result.addError(ssoError); return "registration"; }
         */
